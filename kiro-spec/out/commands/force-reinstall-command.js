...
class ForceReinstallCommand {
    ...
    async execute() {
        try {
            ...
            notifications_1.NotificationManager.showError(`强制重新安装失败: ${error}`);
        }
    }
    /**
     * 注册命令
...
exports.ForceReinstallCommand = ForceReinstallCommand;
//# sourceMappingURL=force-reinstall-command.js.map